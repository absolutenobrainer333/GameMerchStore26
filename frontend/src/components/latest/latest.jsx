...
const Latest = () => {
  const galleryImages = [
    { img: galleryImg1, id: 22 }, // Gekko T-Shirt
    { img: galleryImg2, id: 19 }, // Cypher Black Phone Cover
    { img: galleryImg3, id: 28 }, // Yoru Bottle
    { img: galleryImg4, id: 18 }, // Cat Beanie
    { img: galleryImg5, id: 11 }, // Music Box
    { img: galleryImg6, id: 12 }, // Glow-In-The-Dark Pendant
    { img: galleryImg7, id: 10 }, // UV Hand-Print Mug
    { img: galleryImg8, id: 2  }, // Tarot Cards Crop Hoodie
  ];
      ...
      <div className="container max-w-full pt-12 pb-16 px-8">
        ...
        <section className="featured-products p-8 mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link to="/product/5" className="product p-4 rounded-md hover:opacity-90 transition-opacity">
            ...
            <Link to="/product/23" className="product p-4 rounded-md hover:opacity-90 transition-opacity">
              <img src={img2} alt="Glasses" className="w-full h-auto mb-4" />
              <h4 className="text-xl font-bold">Cool Pixel Glasses</h4>
              <p className="text-lg">$10</p>
            </Link>
            <Link to="/product/27" className="product p-4 rounded-md hover:opacity-90 transition-opacity">
        ...
        <section className="gallery p-8 rounded-md mb-8">
          ...
          <div className="carousel-container">
            <Slider {...settings}>
              {galleryImages.map(({ img, id }, index) => (
                <div key={index} className="p-2">
                  <Link to={`/product/${id}`}>
                    <img
                      src={img}
                      alt="gallery"
                      className="carousel-img rounded-md shadow-lg w-full hover:opacity-90 transition-opacity cursor-pointer"
                    />
                  </Link>
                </div>
              ))}
